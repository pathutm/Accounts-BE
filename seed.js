...
const sampleInvoices = [
  ...
  {"invoice_id":"INV040","customer_id":"C010","invoice_date":"2026-03-15","due_date":"2026-04-30","place_of_supply":"Tamil Nadu","currency":"INR","invoice_summary":{"subtotal":65000,"tax_breakup":{"total_cgst":5850,"total_sgst":5850,"total_igst":0},"grand_total":76700},"payment":{"status":"PARTIALLY_PAID","paid_amount":30000,"pending_amount":46700},"derived_metrics":{"days_overdue":3}}
];
...
const seedData = async () => {
  try {
    ...
    console.log('40 Invoices seeded successfully based on sample data');
